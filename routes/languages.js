...
router.get('/list',function(req,res){
	var db = req.db;
	var collection = db.get('languagelist');
...
*/
router.get('/getspecificlanguagebyid/:id',function(req,res){
	var db = req.db;
	var collection = db.get('languagelist');
