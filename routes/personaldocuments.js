...
/**
* GET personaldocumentlist
*/
router.get('/list',function(req,res){
	var db = req.db;
	var collection = db.get('personaldocumentlist');
...
/*
* DELETE to delete personaldocument
*/
...
/*
* GET  specific personaldocument by id
* this will not be used now as all the data is saved on javascript object. on the browser.
*/
router.get('/getspecificpersonaldocumentbyid/:id',function(req,res){
	var db = req.db;
	var collection = db.get('personaldocumentlist');
...
/*
* Post to update personaldocument
*/
